...
//On click sticky add to cart click main add to cart button so upsell discount applies
document.getElementById('StickyAddToCart').addEventListener('click', function(event) {
        console.log('Sticky Add to Cart button clicked!');
        event.preventDefault(); // Prevent the default click behavior
        // Trigger click on a different button (for example, '#AddToCart')
        document.querySelector('product-payment-container #AddToCart').click();
        console.log('Add to Cart button clicked from JavaScript due to qbk-product-offer.');
});
